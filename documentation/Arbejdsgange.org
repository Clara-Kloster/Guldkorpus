...
|   <5> |         |       |   <5> |        |           | <3> | <5>   | <5>   | <5>   | <5>   |       |      |           |                   |
|-------+---------+-------+-------+--------+-----------+-----+-------+-------+-------+-------+-------+------+-----------+-------------------|
| number |    code | fasc. |  num. |   year | language  | guld | transcriber | facs trans. | facs corr. | dipl trans. | lemma | norm | Lang tags | notes             |
|-------+---------+-------+-------+--------+-----------+-----+-------+-------+-------+-------+-------+------+-----------+-------------------|
...
|   361 |  61-011 | LXI   |    11 |   1432 | Dansk     | X   | BS    | BS    | SDV   | SDV   | SDV   |      |           |                   |
